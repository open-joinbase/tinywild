...
void UI::ProcessSubTitle(uint8_t t) {
    ...
    case 1:
        ...
        spr.drawString("More about JoinBase", 90, 0, GFXFF);
        spr.pushSprite(0, 50);
        spr.deleteSprite();
        break;
    }
...
bool UI::Process_1(uint8_t select) {
    ...
    case 0:
        ...
        spr.drawString("More about", 180, 0, GFXFF);
        spr.drawString("JoinBase", 180, 25, GFXFF);
...
bool UI::Process_2(uint8_t select) {
    ...
    case 1: {
        ...
        qrcode_initText(&qrcode, qrcodeData, 5, 0, "https://joinbase.io");
